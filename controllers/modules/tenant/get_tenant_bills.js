// sql statement to get tenant bills
// select Tenant.first_name, Tenant.last_name, tenant_bill.fees ,tenant_bill.invoice_id,tenant_bill.billing_date,tenant_bill.total from tenant
//  join tenant_bill on tenant.id = tenant_bill.tenant_id
// ;
